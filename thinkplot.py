...
class _Brewer(object):
    ...
    @classmethod
    def _color_generator(cls, num):
        """
        Returns an iterator of color strings.

        Args:
            num: how many colors will be used
        """
...
def _underride_color(options):
    ...
    color_iter = _Brewer._get_iter(5)
...
def _pre_plot(num=None, rows=None, cols=None):
    """
...
def _sub_plot(plot_number, rows=None, cols=None, **options):
    """
...
def _plot(obj, ys=None, style='', **options):
    """
    Plots a line.
...
def _fill_between(xs, y1, y2=None, where=None, **options):
    """
...
def _scatter(xs, ys=None, **options):
    """
...
def _config(**options):
    ...
    Pulls options out of the option dictionary and passes them to the corresponding pyplot functions.
    """
...
def main():
    color_iter = _Brewer._color_generator(7)
