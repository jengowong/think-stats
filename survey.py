...
def main(name, data_dir='.'):
    ...
    print('Respondents.records[0].caseid = ', resp.records[0].caseid)

    preg = Pregnancies()
    preg.ReadRecords(data_dir)
    print('Number of pregnancies', len(preg.records))
    print('Pregnancies.records[2].caseid = ', preg.records[2].caseid)
    print('Pregnancies.records[2].nbrnaliv = ', preg.records[2].nbrnaliv)
    print('Pregnancies.records[2].babysex = ', preg.records[2].babysex)
    print('Pregnancies.records[2].birthwgt_lb = ', preg.records[2].birthwgt_lb)
    print('Pregnancies.records[2].birthwgt_oz = ', preg.records[2].birthwgt_oz)
    print('Pregnancies.records[2].totalwgt_oz = ', preg.records[2].totalwgt_oz)
    print('Pregnancies.records[2].prglength = ', preg.records[2].prglength)
    print('Pregnancies.records[2].outcome = ', preg.records[2].outcome)
    print('Pregnancies.records[2].birthord = ', preg.records[2].birthord)
    print('Pregnancies.records[2].agepreg = ', preg.records[2].agepreg)
    print('Pregnancies.records[2].finalwgt = ', preg.records[2].finalwgt)
